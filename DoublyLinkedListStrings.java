...
/********************************
Name: Miriam Ekiye
MethodsPurposes: Linked list for processing data for Cars and Planes
(linked list Methods)
*******************************/
public class DoublyLinkedListStrings{
 ...
 // Method to add a node to the front(right)
...
//create a node odject and place the value in the node
 ...
 void InsertRear(String data) //Method to add a node at the end(left) of a list
 {
...
void delete_Node(Node head_pointer, Node nDelete)
{
 ...
 static int getSize(Node sizeNode)
 {
 int size = 0;
 while (sizeNode != null)
 {
